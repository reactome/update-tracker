...
import org.reactome.updateTracker.model.ActionObject;
import org.reactome.updateTracker.model.ActionType;
...
public abstract class AbstractPhysicalEntityComparer extends InstanceComparer {
    ...
    private ActionObject getIndirectActionObject(Map.Entry<GKInstance, GKInstance> parentPhysicalEntityPair) {
        if (Utils.bothComplexes(parentPhysicalEntityPair)) {
            return ActionObject.containedComponent;
        } else if (Utils.bothSets(parentPhysicalEntityPair)) {
            return ActionObject.containedMemberOrCandidate;
        } else if (Utils.bothPolymers(parentPhysicalEntityPair)) {
